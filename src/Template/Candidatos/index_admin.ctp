...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col pr-0">
            <h6 class="mt-1"><i class="fas fa-search"></i> Pesquisa <span style="font-size:70%;color:#989898;">( Nome )</span></h6>
            ...
            <div class="w-100" id="tableAjax">
                <?= $this->Element('candidatoTableIndexSearch') ?>
            </div>
...
<script>
    $('document').ready(function() {
        ...
        function searchTags(keyword) {
            ...
            $.ajax({
                method: 'get',
                url: "<?php echo $this->Url->build(['controller' => 'Candidatos', 'action' => 'search']); ?>",
                data: {
                    keyword: data
                },
