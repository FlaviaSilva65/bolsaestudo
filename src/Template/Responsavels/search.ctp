<?= $this->Html->script(['jquery.maskedinput', 'jquery.mask', 'busca_cep']); ?>
    ...
    <div class="row d-flex justify-content-center">
        <?php if ($responsavels) { ?>
            <div class="col-md-10 px-0 d-sm-flex justify-content-center flex-sm-wrap">
                ...
                <div class="col-sm-8 col-md-4">
                    <?= $this->Form->control('nm_email', ['value' => $responsavels->nm_email, 'label' => 'E-mail']); ?>
                </div>
            </div>
            ...
            <?php if ($responsavels->ds_profissao == 'Autônomo') { ?>
                <div class="col-md-12 px-0" id="informacoesProfissao">
                    <div class="col-md-4">
                        <?= $this->Form->control('ds_profissao', ['type' => 'text', 'id' => 'dsProfissao', 'placeholder' => 'Insira a profissão.', 'label' => 'Profissão', 'value' => $responsavels->ds_profissao]); ?>
                    </div>
                </div>
            <?php } else if ($responsavels->ds_profissao != 'Aposentado') { ?>
                ...
                <div id="informacoesTrabalho">
                    <div class="col-md-12 px-0 d-sm-flex flex-sm-wrap">
                        <div class="col-md-4">
                            <?= $this->Form->control('ds_trabalho', ['type' => 'text', 'id' => 'nomeEmpresa', 'placeholder' => 'Insira o nome do local de trabalho.', 'label' => 'Local de trabalho (Nome da Empresa):', 'value' => $responsavels->ds_trabalho]); ?>
                        </div>
                        <div class="col-sm-4 col-md-2">
                            <?= $this->Form->control('vl_cep_trab', ['type' => 'text', 'id' => 'cep', 'class' => 'cep', 'placeholder' => 'CEP ex:. 11999999...', 'label' => 'CEP:', 'value' => $responsavels->vl_cep_trab]); ?>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            <?= $this->Form->control('nm_rua_trab', ['type' => 'text', 'id' => 'logradouro', 'class' => 'logradouro', 'placeholder' => 'Insira o endereço da empresa.', 'label' => 'Endereço:', 'value' => $responsavels->nm_rua_trab]); ?>
                        </div>
                        <div class="col-sm-2 col-md-2">
                            <?= $this->Form->control('vl_numero_trab', ['type' => 'text', 'id' => 'num_rua_resp', 'placeholder' => 'Insira o número.', 'label' => 'Número:', 'value' => $responsavels->vl_numero_trab]); ?>
                        </div>

                        <div class="col-sm-4">
                            <?= $this->Form->control('nm_bairro_trab', ['type' => 'text', 'id' => 'bairro', 'placeholder' => 'Insira o número.', 'label' => 'Bairro:', 'value' => $responsavels->nm_bairro_trab]); ?>
                        </div>
                        <div class="col-sm-4">
                            <?= $this->Form->control('nm_cidade_trab', ['type' => 'text', 'id' => 'cidade', 'placeholder' => 'Insira a cidade.', 'label' => 'Cidade:', 'value' => $responsavels->nm_cidade_trab]); ?>
                        </div>
                        <div class="col-sm-4">
                            <?= $this->Form->control('cd_telefone', ['type' => 'text', 'class' => 'phone_with_ddd', 'placeholder' => 'Telefone da empresa.', 'label' => 'Telefone:', 'value' => $responsavels->cd_telefone]); ?>
                        </div>
                    </div>
                </div>
            <?php } ?>
        ...
        <?php } else { ?>
            <div class="col-md-10 px-0 d-sm-flex justify-content-center flex-sm-wrap">
                ...
                <div class="col-sm-8 col-md-4">
                    <?= $this->Form->control('nm_email', ['label' => 'E-mail']); ?>
                </div>
            </div>
            <div class="col-md-12 ml-md-3 col-sm-12 mt-3 brTitle">
                <p class="mb-lg-2">Informações Profissionais</p>
            ...
            <div class="col-md-12" id="informacoesProfissao" style="display: none;">
                <div class="col-md-4 pl-0">
                    <?= $this->Form->control('ds_profissao', ['type' => 'text', 'id' => 'dsProfissao', 'placeholder' => 'Insira a profissão.', 'label' => 'Profissão']); ?>
                </div>
            </div>
            <div id="informacoesTrabalho" style="display: block;">
                <div class="col-md-12 px-0 d-sm-flex flex-sm-wrap">
                    <div class="col-md-4">
                        <?= $this->Form->control('ds_trabalho', ['type' => 'text', 'id' => 'nomeEmpresa', 'placeholder' => 'Insira o nome do local de trabalho.', 'label' => 'Local de trabalho (Nome da Empresa):']); ?>
                    </div>
                    <div class="col-sm-4 col-md-2">
                        <?= $this->Form->control('vl_cep', ['type' => 'text', 'id' => 'cep', 'class' => 'cep', 'placeholder' => 'CEP ex:. 11999999...', 'label' => 'CEP:']); ?>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <?= $this->Form->control('nm_rua_trab', ['type' => 'text', 'id' => 'logradouroempr', 'class' => 'logradouroempr', 'placeholder' => 'Insira o endereço da empresa.', 'label' => 'Endereço:']); ?>
                    </div>
                    <div class="col-sm-2 col-md-2">
                        <?= $this->Form->control('vl_numero_trab', ['type' => 'text', 'id' => 'num_rua_resp', 'placeholder' => 'Insira o número.', 'label' => 'Número:']); ?>
                    </div>

                    <div class="col-sm-4">
                        <?= $this->Form->control('nm_bairro_trab', ['type' => 'text', 'id' => 'bairroempr', 'placeholder' => 'Insira o número.', 'label' => 'Bairro:']); ?>
                    </div>
                    <div class="col-sm-4">
                        <?= $this->Form->control('nm_cidade_trab', ['type' => 'text', 'id' => 'cidadeempr', 'placeholder' => 'Insira a cidade.', 'label' => 'Cidade:']); ?>
                    </div>
                    <div class="col-sm-4">
                        <?= $this->Form->control('cd_telefone', ['type' => 'text', 'class' => 'phone_with_ddd', 'placeholder' => 'Telefone da empresa.', 'label' => 'Telefone:']); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-12 ml-md-3 col-sm-12 mt-3 brTitle">
            ...
            <div class="col-md-12 px-0 d-sm-flex flex-sm-wrap">
                <div class="col-md-3">
                    <?= $this->Form->control('concessao_fam', ['id' => 'concessao_fam', 'type' => 'select', 'class' => 'p-1 w-100', 'empty' => '---', 'options' => [0 => 'Sim / Bolsa Parcial', 1 => 'Sim / Bolsa Integral', 2 => 'Sim / Transp. Univ.', 3 => 'Não'], 'label' => 'Concessão Familiar', 'onChange' => 'ativaDadosBolsa(this)']); ?>
                </div>
                <div class="col-md-5" id="informacoesBolsa1" style="display: none;">
                    <?= $this->Form->control('concessao_aluno', ['placeholder' => 'Nome do aluno que possui bolsa', 'label' => 'Nome completo do aluno:']); ?>
                </div>

                <div class="col-md-4" id="informacoesBolsa2" style="display: none;">
                    <?= $this->Form->control('concessao_escola', ['id' => 'nm_escola', 'empty' => 'Selecione a escola', 'options' => $escolas, 'class' => 'p-1 w-100', 'label' => 'Nome da escola: ']); ?>
                </div>
            </div>
